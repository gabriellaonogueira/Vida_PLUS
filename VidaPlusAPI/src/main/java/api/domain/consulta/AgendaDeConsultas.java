...
import api.domain.consulta.validacoes.agendamento.ValidadorAgendamentoDeConsulta;
...
public class AgendaDeConsultas {
    ...
    public DadosDetalhamentoConsulta agendar(DadosAgendamentoConsulta dados) {
        ...
        var consulta = new Consulta(null, medico, paciente, dados.data(), dados.tipoConsulta(), null);
